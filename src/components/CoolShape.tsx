...
const CoolShape: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 200 200" className={className}>
    <g clipPath="url(#cs_clip_1_misc-8)">
      <mask id="cs_mask_1_misc-8" style={{ maskType: 'alpha' }} width="170" height="200" x="15" y="0" maskUnits="userSpaceOnUse">
