export const HOME_CONFIG = {
  ...
  whyChooseUs: {
    ...
    description: 'With over a decade of experience in the travel industry, we understand that every journey is unique. We don\'t just book tickets; we create memories.',
    image: 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&q=80&w=800',
    features: [
      { title: "Trusted Service", desc: "10,000+ happy travelers across the globe." },
      { title: "Customized Trips", desc: "Tailor-made itineraries for your unique needs." },
      { title: "Best Pricing", desc: "Unbeatable luxury at the most competitive rates." },
      { title: "24/7 Support", desc: "We are with you at every step of your journey." },
    ]
  },
  destinations: {
    title: 'Popular',
  ...
  cta: {
    ...
    titleLine2: 'Vacation With Us',
    description: 'Ready to embark on your next adventure? Contact us today and let\'s create your perfect itinerary.',
    whatsappMessage: 'Hi! I want to plan my dream vacation. Please help me with itineraries.'
  }
};
